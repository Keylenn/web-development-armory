!function (t, e) {
  ...
  return function (t) {
    ...
    var r, a = n(1), o = n(3), u = n(5), i = n(20), l = n(23), s = n(25);
	...
	*/
    ...
    Handler.gen = function (t, e, n) {
      ...
      array: function (t) {
        ...
        var e, n, r, a, o, u, i = {};
        if (void 0 != t.rule.min) for (e = Util.keys(t.template), e = Random.shuffle(e), e = e.slice(0, t.rule.count), u = 0; u < e.length; u++) r = e[u], a = r.replace(Constant.RE_KEY, "$1"), t.context.path.push(a), t.context.templatePath.push(r), i[a] = Handler.gen(t.template[r], r, {
          path: t.context.path,
          templatePath: t.context.templatePath,
          currentContext: i,
          templateCurrentContext: t.template,
          ...
          for (e = e.concat(n), u = 0; u < e.length; u++) r = e[u], a = r.replace(Constant.RE_KEY, "$1"), t.context.path.push(a), t.context.templatePath.push(r), i[a] = Handler.gen(t.template[r], r, {
            path: t.context.path,
            templatePath: t.context.templatePath,
            currentContext: i,
            templateCurrentContext: t.template,
      ...
      _all: function () {
        ...
        return o && t in o ? o[t] : u && "object" == typeof u && t in u && n !== u[t] ? (u[t] = Handler.gen(u[t], t, {
          currentContext: o,
    ...
    var n = {};
    n.extend = function () {
      var t, e, r, a, o, u = arguments[0] || {}, i = 1, l = arguments.length;
      for (1 === l && (u = this, i = 0); l > i; i++) if (t = arguments[i]) for (e in t) r = u[e], a = t[e], u !== a && void 0 !== a && (n.isArray(a) || n.isObject(a) ? (n.isArray(a) && (o = r && n.isArray(r) ? r : []), n.isObject(a) && (o = r && n.isObject(r) ? r : {}), u[e] = n.extend(o, a)) : u[e] = a);
      return u;
    }, n.each = function (t, e, n) {
      var r, a;
      if ("number" === this.type(t)) for (r = 0; t > r; r++) e(r, r); else if (t.length === +t.length) for (r = 0; r < t.length && e.call(n, t[r], r, t) !== !1; r++) ; else for (a in t) if (e.call(n, t[a], a, t) === !1) break;
    }, n.type = function (t) {
    ...
    t.exports = {
      parse: function (t) {
        t = void 0 == t ? "" : t + "";
        var e = (t || "").match(r.RE_KEY), n = e && e[3] && e[3].match(r.RE_RANGE), o = n && n[1] && parseInt(n[1], 10),
          u = n && n[2] && parseInt(n[2], 10), i = n ? n[2] ? a.integer(o, u) : parseInt(n[1], 10) : void 0,
          l = e && e[4] && e[4].match(r.RE_RANGE), s = l && parseInt(l[1], 10), c = l && parseInt(l[2], 10),
    ...
    (function (t) {
      t.exports = {
        ...
        dataImage: function (e, n) {
          ...
          var u = parseInt(e[0], 10), i = parseInt(e[1], 10), l = this._brandColors[this.pick(this._brandNames())],
            s = "#FFF", c = 14, h = "sans-serif";
    ...
    t.exports = {
      rgb2hsl: function (t) {
        var e, n, r, a = t[0] / 255, o = t[1] / 255, u = t[2] / 255, i = Math.min(a, o, u), l = Math.max(a, o, u),
          s = l - i;
        ...
        var e, n, r, a = t[0], o = t[1], u = t[2], i = Math.min(a, o, u), l = Math.max(a, o, u), s = l - i;
        ...
        var e, n, r, a, o, u = t[0] / 360, i = t[1] / 100, l = t[2] / 100;
        ...
        var e, n, r = t[0], a = t[1] / 100, o = t[2] / 100;
        return o *= 2, a *= 1 >= o ? o : 2 - o, n = (o + a) / 2, e = 2 * a / (o + a), [r, 100 * e, 100 * n];
      }, hsv2rgb: function (t) {
        var e = t[0] / 60, n = t[1] / 100, r = t[2] / 100, a = Math.floor(e) % 6, o = e - Math.floor(e),
          u = 255 * r * (1 - n), i = 255 * r * (1 - n * o), l = 255 * r * (1 - n * (1 - o));
        switch (r = 255 * r, a) {
          case 0:
            return [r, l, u];
          case 1:
    ...
    t.exports = {
      capitalize: function (t) {
        ...
        var e = a.options, n = e.context.templatePath.join("."), r = a.cache[n] = a.cache[n] || {index: 0, array: t};
    ...
    t.exports = {
      region: function () {
        ...
        var e = this.pick(r), n = this.pick(e.children), a = this.pick(n.children) || {name: "-"};
    ...
    var v = function () {
      ...
      function v(t) {
        ...
        function k() {
          var t, e, n, r, a;
          if (t = Zn, e = R(), null === e && (e = Et), null !== e) if (n = Zn, ar++, r = M(), ar--, null === r ? n = Et : (Zn = n, n = kt), null !== n) {
        ...
        function O() {
          var e, n, r;
          if (e = Zn, n = [], ae.test(t.charAt(Zn)) ? (r = t.charAt(Zn), Zn++) : (r = null, 0 === ar && b(oe)), null !== r) for (; null !== r;) n.push(r), ae.test(t.charAt(Zn)) ? (r = t.charAt(Zn), Zn++) : (r = null, 0 === ar && b(oe)); else n = kt;
        ...
        function B() {
          var e, n, r, a, o;
          if (ar++, e = Zn, 91 === t.charCodeAt(Zn) ? (n = ke, Zn++) : (n = null, 0 === ar && b(Ee)), null !== n) if (94 === t.charCodeAt(Zn) ? (r = Pt, Zn++) : (r = null, 0 === ar && b(Tt)), null === r && (r = Et), null !== r) {
        ...
        function dt() {
          ...
          if (e = Zn, t.substr(Zn, 2) === In ? (n = In, Zn += 2) : (n = null, 0 === ar && b(jn)), null !== n) {
            if (r = [], Nn.test(t.charAt(Zn)) ? (a = t.charAt(Zn), Zn++) : (a = null, 0 === ar && b(zn)), null !== a) for (; null !== a;) r.push(a), Nn.test(t.charAt(Zn)) ? (a = t.charAt(Zn), Zn++) : (a = null, 0 === ar && b(zn)); else r = kt;
        ...
        function mt() {
          ...
          if (e = Zn, t.substr(Zn, 2) === Bn ? (n = Bn, Zn += 2) : (n = null, 0 === ar && b(Gn)), null !== n) {
            if (r = [], Xn.test(t.charAt(Zn)) ? (a = t.charAt(Zn), Zn++) : (a = null, 0 === ar && b(Kn)), null !== a) for (; null !== a;) r.push(a), Xn.test(t.charAt(Zn)) ? (a = t.charAt(Zn), Zn++) : (a = null, 0 === ar && b(Kn)); else r = kt;
        ...
        var yt, bt = arguments.length > 1 ? arguments[1] : {}, wt = {regexp: C}, Ct = C, kt = null, Et = "", Rt = "|",
          At = '"|"', _t = function (t, e) {
            ...
            return new i(t, e);
          }, Lt = "Quantifier", Ot = function (t, e) {
            return e && (t.greedy = !1), t;
          }, It = "{", jt = '"{"', Nt = ",", zt = '","', Ut = "}", Bt = '"}"', Gt = function (t, e) {
            return new l(t, e);
          }, Xt = ",}", Kt = '",}"', Wt = function (t) {
            return new l(t, 1 / 0);
          }, Yt = function (t) {
            ...
            return new l(0, 1);
          }, ae = /^[0-9]/, oe = "[0-9]", ue = function (t) {
            return +t.join("");
          }, ie = "(", le = '"("', se = ")", ce = '")"', he = function (t) {
            return t;
          }, pe = function (t) {
            return new u(t);
          }, fe = "?:", de = '"?:"', me = function (t) {
          ...
          }, Ce = "CharacterSet", ke = "[", Ee = '"["', Re = "]", Ae = '"]"', _e = function (t, e) {
            return new s(!!t, e);
          }, Me = "CharacterRange", Pe = "-", Te = '"-"', He = function (t, e) {
            return new c(t, e);
          }, Se = "Character", De = /^[^\\\]]/, qe = "[^\\\\\\]]", Fe = function (t) {
            return new h(t);
          }, Le = ".", Oe = '"."', Ie = function () {
            return new n("any-character");
          }, je = "Literal", Ne = /^[^|\\\/.[()?+*$\^]/, ze = "[^|\\\\\\/.[()?+*$\\^]", Ue = "\\b", Be = '"\\\\b"',
          Ge = function () {
          ...
          }, Pn = "\\c", Tn = '"\\\\c"', Hn = "any character", Sn = function (t) {
            return new g(t);
          }, Dn = "\\", qn = '"\\\\"', Fn = /^[1-9]/, Ln = "[1-9]", On = function (t) {
            return new m(t);
          }, In = "\\0", jn = '"\\\\0"', Nn = /^[0-7]/, zn = "[0-7]", Un = function (t) {
            return new d(t.join(""));
          }, Bn = "\\x", Gn = '"\\\\x"', Xn = /^[0-9a-fA-F]/, Kn = "[0-9a-fA-F]", Wn = function (t) {
            return new f(t.join(""));
          }, Yn = "\\u", $n = '"\\\\u"', Jn = function (t) {
            return new p(t.join(""));
          }, Vn = function () {
            return new n("null-character");
          }, Zn = 0, Qn = 0, tr = 0, er = {line: 1, column: 1, seenCR: !1}, nr = 0, rr = [], ar = 0;
        if ("startRule" in bt) {
    ...
    var a = n(3), o = n(5), u = {extend: a.extend}, i = r(97, 122), l = r(65, 90), s = r(48, 57),
      c = r(32, 47) + r(58, 64) + r(91, 96) + r(123, 126), h = r(32, 126), p = " \f\n\r	\x0B \u2028\u2029", f = {
        "\\w": i + l + s + "_", "\\W": c.replace("_", ""), "\\s": p, "\\S": function () {
    ...
    u.gen = function (t, e, n) {
      ...
      token: function (t, e, n) {
        ...
        var r = Math.max(t.min, 0), a = isFinite(t.max) ? t.max : r + o.integer(3, 7);
        ...
        var r = this.gen(t.start, e, n).charCodeAt(), a = this.gen(t.end, e, n).charCodeAt();
    ...
    var a = n(2), o = n(3), u = n(23), i = {
      diff: function (t, e, n) {
        ...
        var o = r.length, u = t.rule, i = t.type;
        if ("object" !== i && "array" !== i) {
          if (!u.parameters) {
            switch (i) {
              case"regexp":
          ...
          switch (i) {
            case"number":
              var c = (e + "").split(".");
              c[0] = +c[0], void 0 !== u.min && void 0 !== u.max && (l.greaterThanOrEqualTo("value", t.path, c[0], u.min, r), l.lessThanOrEqualTo("value", t.path, c[0], u.max, r)), void 0 !== u.min && void 0 === u.max && l.equal("value", t.path, c[0], u.min, r, "[value] " + n), u.decimal && (void 0 !== u.dmin && void 0 !== u.dmax && (l.greaterThanOrEqualTo("value", t.path, c[1].length, u.dmin, r), l.lessThanOrEqualTo("value", t.path, c[1].length, u.dmax, r)), void 0 !== u.dmin && void 0 === u.dmax && l.equal("value", t.path, c[1].length, u.dmin, r));
              break;
            case"boolean":
              break;
            case"string":
              s = e.match(new RegExp(t.template, "g")), s = s ? s.length : s, void 0 !== u.min && void 0 !== u.max && (l.greaterThanOrEqualTo("repeat count", t.path, s, u.min, r), l.lessThanOrEqualTo("repeat count", t.path, s, u.max, r)), void 0 !== u.min && void 0 === u.max && l.equal("repeat count", t.path, s, u.min, r);
              break;
            case"regexp":
              s = e.match(new RegExp(t.template.source.replace(/^\^|\$$/g, ""), "g")), s = s ? s.length : s, void 0 !== u.min && void 0 !== u.max && (l.greaterThanOrEqualTo("repeat count", t.path, s, u.min, r), l.lessThanOrEqualTo("repeat count", t.path, s, u.max, r)), void 0 !== u.min && void 0 === u.max && l.equal("repeat count", t.path, s, u.min, r);
          }
          return r.length === o;
        }
      }, properties: function (t, e, n, r) {
        var a = r.length, u = t.rule, i = o.keys(e);
        if (t.properties) {
          ...
          for (var s = 0; s < i.length; s++) r.push.apply(r, this.diff(t.properties[s], e[i[s]], i[s]));
          return r.length === a;
        }
    ...
    function a() {
      ...
      var n = function () {
        var t = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/,
          e = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, n = location.href, r = e.exec(n.toLowerCase()) || [];
        return t.test(r[1]);
      }();
    ...
    var s = {UNSENT: 0, OPENED: 1, HEADERS_RECEIVED: 2, LOADING: 3, DONE: 4},
      ...
      p = "readyState responseURL status statusText responseType response responseText responseXML".split(" "), f = {
        100: "Continue",
    ...
    r._settings = {timeout: "10-100"}, r.setup = function (t) {
      ...
      responseURL: "", status: r.UNSENT, statusText: "", getResponseHeader: function (t) {
