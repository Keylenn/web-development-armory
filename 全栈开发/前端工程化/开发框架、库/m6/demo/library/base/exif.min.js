(function () {
  ...
  function i(e, n) {
    ...
    if (e.src) if (/^data\:/i.test(e.src)) i(t(e.src)); else if (/^blob\:/i.test(e.src)) (l = new FileReader).onload = function (e) {
      i(e.target.result);
    }, r(e.src, function (e) {
  ...
  function l(e, t, n, r, i) {
    var o, a, s, l = e.getUint16(n, !i), c = {};
    for (s = 0; s < l; s++) o = n + 12 * s + 2, !(a = r[e.getUint16(o, !i)]) && S && console.log("Unknown tag: " + e.getUint16(o, !i)), c[a] = u(e, o, t, n, i);
    return c;
  }

  function u(e, t, n, r, i) {
    var o, a, s, l, u, c, d = e.getUint16(t + 2, !i), g = e.getUint32(t + 4, !i), m = e.getUint32(t + 8, !i) + n;
    switch (d) {
      case 1:
      case 7:
    ...
    if (o.Compression) switch (o.Compression) {
      case 6:
        if (o.JpegIFOffset && o.JpegIFByteCount) {
          var a = t + o.JpegIFOffset, s = o.JpegIFByteCount;
  ...
  function m(e) {
    if ("DOMParser" in self) {
      ...
      for (var n = 2, r = e.byteLength, i = new DOMParser; n < r - 4;) {
        if ("http" == f(t, n, 4)) {
          var o = f(t, n - 1, t.getUint16(n - 2) - 1), a = o.indexOf("xmpmeta>") + 8,
