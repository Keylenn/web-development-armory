...
!function (t, n) {
  ...
  return function (t) {
    ...
    var a = e(7), c = o(a), u = e(8), s = o(u), f = e(9), l = o(f);
    ...
    n.stripBasename = function (t, n) {
      ...
      var n = t.pathname, e = t.search, o = t.hash, r = n || "/";
    ...
    var r = Object.assign || function (t) {
      ...
      return t;
    }, i = e(10), a = o(i), c = e(11), u = o(c), s = e(1);
    ...
    var r = ("function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return t;
      }), i = e(3), a = (o(i), e(6)), c = o(a), u = e(2), s = e(1), f = e(4), l = o(f), d = e(5), h = "popstate",
      p = "hashchange", v = function () {
        try {
        ...
        var n = window.history, e = (0, d.supportsHistory)(), o = !(0, d.supportsPopStateOnHashChange)(),
          i = t.forceRefresh, a = void 0 !== i && i, f = t.getUserConfirmation, y = void 0 === f ? d.getConfirmation : f,
          g = t.keyLength, m = void 0 === g ? 6 : g,
          w = t.basename ? (0, s.stripTrailingSlash)((0, s.addLeadingSlash)(t.basename)) : "", b = function (t) {
            var n = t || {}, e = n.key, o = n.state, r = window.location, i = r.pathname, a = r.search, c = r.hash,
              f = i + a + c;
            return w && (f = (0, s.stripBasename)(f, w)), (0, u.createLocation)(f, o, e);
          }, P = function () {
            return Math.random().toString(36).substr(2, m);
          }, O = (0, l.default)(), L = function (t) {
            ...
            var n = G.location, e = M.indexOf(n.key);
            e === -1 && (e = 0);
            var o = M.indexOf(t.key);
            o === -1 && (o = 0);
            var r = e - o;
            r && (E = !0, U(r));
          }, k = b(v()), M = [k.key], T = function (t) {
            return w + (0, s.createPath)(t);
          }, H = function (t, o) {
            var r = "PUSH", i = (0, u.createLocation)(t, o, P(), G.location);
            O.confirmTransitionTo(i, r, y, function (t) {
              if (t) {
                var o = T(i), c = i.key, u = i.state;
                if (e) if (n.pushState({key: c, state: u}, null, o), a) window.location.href = o; else {
                  var s = M.indexOf(G.location.key), f = M.slice(0, s === -1 ? 0 : s + 1);
                  f.push(i.key), M = f, L({action: r, location: i});
                } else window.location.href = o;
              }
            });
          }, j = function (t, o) {
            var r = "REPLACE", i = (0, u.createLocation)(t, o, P(), G.location);
            O.confirmTransitionTo(i, r, y, function (t) {
              if (t) {
                var o = T(i), c = i.key, u = i.state;
                if (e) if (n.replaceState({key: c, state: u}, null, o), a) window.location.replace(o); else {
                  var s = M.indexOf(G.location.key);
                  s !== -1 && (M[s] = i.key), L({action: r, location: i});
            ...
            var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], n = O.setPrompt(t);
    ...
    var r = Object.assign || function (t) {
      ...
      return t;
    }, i = e(3), a = (o(i), e(6)), c = o(a), u = e(2), s = e(1), f = e(4), l = o(f), d = e(5), h = "hashchange", p = {
      hashbang: {
      ...
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      d.canUseDOM ? void 0 : (0, c.default)(!1);
      var n = window.history, e = ((0, d.supportsGoWithoutReloadUsingHash)(), t.getUserConfirmation),
        o = void 0 === e ? d.getConfirmation : e, i = t.hashType, a = void 0 === i ? "slash" : i,
        f = t.basename ? (0, s.stripTrailingSlash)((0, s.addLeadingSlash)(t.basename)) : "", m = p[a], w = m.encodePath,
        b = m.decodePath, P = function () {
          var t = b(v());
          return f && (t = (0, s.stripBasename)(t, f)), (0, u.createLocation)(t);
        }, O = (0, l.default)(), L = function (t) {
          r(V, t), V.length = n.length, O.notifyListeners(V.location, V.action);
        }, x = !1, S = null, E = function () {
          var t = v(), n = w(t);
          if (t !== n) g(n); else {
            var e = P(), o = V.location;
          ...
          var n = V.location, e = H.lastIndexOf((0, s.createPath)(n));
          e === -1 && (e = 0);
      ...
      k !== M && g(M);
      var T = P(), H = [(0, s.createPath)(T)], j = function (t) {
        return "#" + w(f + (0, s.createPath)(t));
      }, U = function (t, n) {
        var e = "PUSH", r = (0, u.createLocation)(t, void 0, void 0, V.location);
        O.confirmTransitionTo(r, e, o, function (t) {
          if (t) {
            var n = (0, s.createPath)(r), o = w(f + n), i = v() !== o;
            if (i) {
              S = n, y(o);
              var a = H.lastIndexOf((0, s.createPath)(V.location)), c = H.slice(0, a === -1 ? 0 : a + 1);
              c.push(n), H = c, L({action: e, location: r});
            } else L();
          }
        });
      }, C = function (t, n) {
        var e = "REPLACE", r = (0, u.createLocation)(t, void 0, void 0, V.location);
        O.confirmTransitionTo(r, e, o, function (t) {
          if (t) {
            var n = (0, s.createPath)(r), o = w(f + n), i = v() !== o;
            i && (S = n, g(o));
            var a = H.indexOf((0, s.createPath)(V.location));
            a !== -1 && (H[a] = n), L({action: e, location: r});
          }
        });
      }, R = function (t) {
        n.go(t);
    ...
    var r = ("function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
      ...
      return t;
    }), i = e(3), a = (o(i), e(1)), c = e(2), u = e(4), s = o(u), f = function (t, n, e) {
      return Math.min(Math.max(t, n), e);
    }, l = function () {
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = t.getUserConfirmation,
        e = t.initialEntries, o = void 0 === e ? ["/"] : e, i = t.initialIndex, u = void 0 === i ? 0 : i,
        l = t.keyLength, d = void 0 === l ? 6 : l, h = (0, s.default)(), p = function (t) {
          r(_, t), _.length = _.entries.length, h.notifyListeners(_.location, _.action);
        }, v = function () {
          return Math.random().toString(36).substr(2, d);
        }, y = f(u, 0, o.length - 1), g = o.map(function (t) {
          return "string" == typeof t ? (0, c.createLocation)(t, void 0, v()) : (0, c.createLocation)(t, void 0, t.key || v());
        }), m = a.createPath, w = function (t, e) {
          var o = "PUSH", r = (0, c.createLocation)(t, e, v(), _.location);
          h.confirmTransitionTo(r, o, n, function (t) {
            if (t) {
              var n = _.index, e = n + 1, i = _.entries.slice(0);
              i.length > e ? i.splice(e, i.length - e, r) : i.push(r), p({action: o, location: r, index: e, entries: i});
            }
          });
        }, b = function (t, e) {
          var o = "REPLACE", r = (0, c.createLocation)(t, e, v(), _.location);
          h.confirmTransitionTo(r, o, n, function (t) {
            t && (_.entries[_.index] = r, p({action: o, location: r}));
          });
        }, P = function (t) {
          var e = f(_.index + t, 0, _.entries.length - 1), o = "POP", r = _.entries[e];
          h.confirmTransitionTo(r, o, n, function (t) {
    ...
    function r(t) {
      var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", r = t && t.split("/") || [],
        i = n && n.split("/") || [], a = t && e(t), c = n && e(n), u = a || c;
